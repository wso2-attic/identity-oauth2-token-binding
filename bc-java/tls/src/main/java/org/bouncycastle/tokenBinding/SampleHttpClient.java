...
//        String secTokenBinding=new String(Base64.encodeBase64URLSafe(createTokenBindingMessage(providedKeypair,
//                negotiatedTokenBinding)));
        ...
        String data4 = URLEncoder.encode("client_id", "UTF-8") + "=" + URLEncoder.encode("dm6iMO5R9SAy5mAmIBFkYViQTeIa", "UTF-8");
        String data5 = URLEncoder.encode("client_secret", "UTF-8") + "=" + URLEncoder.encode("9X3_v27d1ftoLnyUXKgr8b1_qRka", "UTF-8");
