...
//    public List<Integer> getTokenBindingVerison(){
//        List<Integer> protocolVersion = new ArrayList<Integer>();
//        protocolVersion.add(MajorProtocolVerison);
//        protocolVersion.add(MinorProtocolVerison);
//        return protocolVersion;
//    }

    public void encode (OutputStream output) throws IOException {
        ByteArrayOutputStream buf = new ByteArrayOutputStream();
        int version[]={MinorProtocolVerison, MajorProtocolVerison};
